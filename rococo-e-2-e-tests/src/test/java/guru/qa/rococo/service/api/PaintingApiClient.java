...
public class PaintingApiClient implements PaintingClient, RequestExecutor {
  ...
  public @NonNull RestResponsePage<PaintingJson> getPaintings(@Nullable Integer page,
    ...
    return executePage(paintingApi.getPaintings(page, size, sort, title));
  }
  ...
  @Override
  public @NonNull RestResponsePage<PaintingJson> getPaintingByAuthorId(@Nullable Integer page,
                                                                       @Nullable Integer size,
                                                                       @Nullable String sort,
                                                                       @NonNull UUID authorId) {
    return executePage(paintingApi.getPaintingByAuthorId(page, size, sort, authorId));
  }
