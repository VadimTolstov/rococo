...
public class MuseumMapper {
   ...
   */
  public static @NonNull MuseumJson mapToJson(@NonNull MuseumEntity entity) {
    return new MuseumJson(
        ...
        entity.getPhoto() != null && entity.getPhoto().length > 0
            ...
            : null,
        GeoMapper.mapToJson(entity.getGeo())
    );
  }
  ...
  public static @NonNull MuseumEntity mapToEntity(@NonNull MuseumJson json) {
    return new MuseumEntity(
        ...
        json.geo() != null ? GeoMapper.mapToEntity(json.geo()) : null
    );
  }
}
